...
def upgrade_helper() -> None:
    ...
    create_new_user_helper(username="Pikachu", email="Pikachu@gmail.com", password="snorlax",
    ...
    create_new_user_helper(username="Bob_the_dev", email="bob_dev@gmail.com", password="IamDev",
                    image="https://res.cloudinary.com/practicaldev/image/fetch/s--h93cj2BI--/c_fill,f_auto,fl_progressive,h_320,q_auto,w_320/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/336281/766eff39-964e-4acc-a390-bc0e2bc9d459.jpg")
    ...
    create_new_article_helper(slug="Dev_updates_2", title="Dev updates #2",
                       ...
                       author_id="2",
                       tags=["dev", "updates"])
    create_new_user_helper(username="Hodor", email="holdthedoor@gmail.com", password="NoSecIssues",
                    image="https://pyxis.nymag.com/v1/imgs/9bc/c6e/b9ba697b64de36b21e4d2dfb1755b20bbb-23-got-ep-5-002.rsquare.w700.jpg")
    ...
    create_new_article_helper(slug="Dev_updates_4", title="Dev updates #4",
                       ...
                       author_id="3",
                       tags=["security", "dev", "updates"])
    create_new_article_helper(slug="I am Pikachu!", title="I am Pikachu!",
                       description="I am the only Pikachu here, you cant have it!",
                       body="There is only one Pikachu! you can be Balbazur if you want.. contact me at Pikachu@gmail.com",
                       author_id="1",
                       tags=["pokemon"])
    create_new_article_helper(slug="My favourite pokemons!", title="My favourites pokemons!",
                       description="You will never guess what are my favourite pokemons!",
                       body="charizard\ngengar\narcanine\nbulbasaur \ndragonite\nsnorlax\nninetals\nsquirtle",
                       author_id="1",
                       tags=["pokemon"])
    create_new_user_helper(username="Ash Ketchum", email="Ash Ketchum@gmail.com", password="Gotta Catch ’Em All",
                    image="https://i.stack.imgur.com/3N48C.png?s=256&g=1")
    create_new_user_helper(username="Blastoise", email="Blastoise@gmail.com", password="powerfulwater",
                    image="https://www.serebii.net/dungeonrescueteamdx/pokemon/009.png")
    create_new_user_helper(username="Dragonite", email="Dragonite@gmail.com", password="firebomb",
                    image="https://static.wikia.nocookie.net/pkmnshuffle/images/a/a6/Dragonite.png/revision/latest?cb=20170407191605")
    create_new_user_helper(username="Gengar", email="Gengar@gmail.com", password="ghostly",
                    image="https://i.pinimg.com/736x/54/2c/7f/542c7f7e89f0deb1186bbf9242ebc3ae.jpg")
