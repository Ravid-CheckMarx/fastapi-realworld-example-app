...
def upgrade() -> None:
    ...
    create_new_user(username="Bob_the_dev", email="bob_dev@gmail.com", password="IamDev", image="https://res.cloudinary.com/practicaldev/image/fetch/s--h93cj2BI--/c_fill,f_auto,fl_progressive,h_320,q_auto,w_320/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/336281/766eff39-964e-4acc-a390-bc0e2bc9d459.jpg")
    ...
    create_new_article(slug="Dev_updates_2", title="Dev updates #2",
                       ...
                       author_id="2",
                       tags=["dev", "updates"])
    create_new_user(username="Hodor", email="holdthedoor@gmail.com", password="NoSecIssues", image="https://pyxis.nymag.com/v1/imgs/9bc/c6e/b9ba697b64de36b21e4d2dfb1755b20bbb-23-got-ep-5-002.rsquare.w700.jpg")
    ...
    create_new_user(username="Dragonite", email="Dragonite@gmail.com", password="firebomb", image="https://static.wikia.nocookie.net/pkmnshuffle/images/a/a6/Dragonite.png/revision/latest?cb=20170407191605")
    create_new_user(username="Gengar", email="Gengar@gmail.com", password="ghostly", image="https://i.pinimg.com/736x/54/2c/7f/542c7f7e89f0deb1186bbf9242ebc3ae.jpg")
